...
def balanced(m):
    ...
    if is_planet(m):
        ...
        left_mass,right_mass = total_mass(end(left(m))),total_mass(end(right(m)))
        now_balance = (left_len * left_mass == right_len * right_mass)
        return now_balance and balanced(end(left(m))) and balanced(end(right(m)))
